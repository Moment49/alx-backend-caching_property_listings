...
SECRET_KEY = 'django-insecure-hfv_rzmuncr74+6*ox8o)__=an+!i4@)h=4knfc-z2t#bt(#$t'
...
CACHES = {
    "default": {
        ...
        "LOCATION": "redis://cache:6379/1", # Use the service name 'cache' defined in docker-compose.yml
        "OPTIONS": {
